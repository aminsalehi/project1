...
Button(f1, text=' Calculation ', bg="white", fg="black", command=lambda: change_frame(f2)).place(x=450, y=250)
...
Button(f1, text='Comparison', bg="black", fg="white", command=hf3).place(x=450, y=350)


f2entry = Text(f2, bg="green", fg="white", height=30, width=110)
...
btn = Button(f2, text="Calculate", bg="black", fg="white", command=calc_handle).place(x=730, y=550)

Label(f3).place(x=0, y=0, relwidth=1, relheight=1)
f3entry = Text(f3, bg="green", fg="black", height=40, width=55)
...
f3entry2 = Text(f3, bg="green", fg="white", height=40, width=55)
...
compare_btn = Button(f3,
                     text="Compare",
                     bg="black", fg="white", command=compare_handle)
